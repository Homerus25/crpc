...
namespace project
{
    ...
    void connection_impl::run(std::function<void(std::string)> incomingMessageCallback)
    {
        ...
        net::co_spawn(
            ...
            [this, on_connect, on_message]() -> net::awaitable< void > {
                ...
                */
            [this, on_connect, incomingMessageCallback]() -> net::awaitable< void > {
                co_await run_state(*this, on_connect, incomingMessageCallback);
            },
            spawn_handler("run"));
    }
